		...
		<div class="row">
			<div class="col-md-9">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#">Messages reçus <span class="badge">2</span> </a></li>
						...
						<?php 
							foreach($mailbox as $i => $mess) {	
								...
								$objet = ($mess['title'] == "" || !isset($mess['title']))?"- Aucun objet -":$mess['title'];
									echo "<a href='message_recu.php?n=$i' class='list-group-item'>
											<div class='row'>
												<div class='col-md-4'>
													<div class='bold'>{$mess['fromName']} {$mess['fromSurname']}</div>
												</div>
												<div class='col-md-5'>
												$objet
												</div>
							...
							?>
						<!--<a href="message_recu.html" class="list-group-item">
							<div class="col-md-4">
							Expéditeur
							</div>
							<div class="col-md-7">
