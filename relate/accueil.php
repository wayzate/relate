...
<title>Relate</title>
	...
	<link rel="STYLESHEET" type="text/CSS" href="css/styleaccueil.css" media="screen" />
...
<input type='hidden' name='submitted' value='1'/>
				...
				<div class='container'>
					...
					<div class="popup_block_acc" id="_connexion">
						<div id='fg_membersite'>
							<form id='login'
...
<input type='hidden' name='submitted' value='1'/>
				...
				<div class='container'>
					...
					<div class="popup_block_acc" id="_inscription">
<div id='fg_membersite'>
...
<div> <!--id="bloc"--> 
    ...
    <div> <!--id="contenubloc"-->
        <img src="theme/slider.png">
        <!-- <a href='#' class="decouvrez">Découvrez Relate</a> -->
    </div>
...
$(document).ready(function(){
	...
	$('a.close, #fade').live('click', function() { //When clicking on the close or fade layer...
	  	$('#fade , .popup_block_acc').fadeOut(function() {
			$('#fade, a.close').remove();  
	}); //fade them both out
