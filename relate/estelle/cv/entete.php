...
function Photo(&$pdf,$id)
{
    ...
    // Photo
    $pdf->Image('../images/CadrePhoto.png');
    // Position
    $pdf-> SetXY(151,9);
	// Photo
...
function Naissance(&$pdf,$genre,$jour,$mois,$annee)
{ 
    // Afficher correctement le jour et le mois
	$valjour = $this->CorrigerDate($jour) ;
	$valmois = $this->CorrigerDate($mois) ;
...
function Tel(&$pdf,$num)
{
    ...
    $pdf->Cell(-8);
	// Image
	$pdf->Image('../images/logo_telephone.png');
	// Décalage à droite
    $pdf->Cell(8);
	// Arial 11
    $pdf->SetFont('Arial','',11);
...
function Email(&$pdf,$email)
{
    ...
    $pdf->Cell(-8);
	// Image
	$pdf->Image('../images/logo_mail.png');
	 // Décalage à droite
    $pdf->Cell(8);
	 // Arial 11
    $pdf->SetFont('Arial','',11);
...
{
	if ($duree == 0) {return ("d'1 à 3 mois");}
	if ($duree == 1) {return('de 3 à 6 mois');}
	if ($duree == 2) {return('de 6 à 9 mois');}
	if ($duree == 3) {return('de 9 à 12 mois');}
	if ($duree == 4) {return("d'1 an ou plus");}
}

function AssocierDomaine($domaine)
{
	if ($domaine == 0) {return('Audit/Conseil');}
	if ($domaine == 1) {return('Banque/Assurance');}
	if ($domaine == 2) {return('BTP/Immobilier');}
	if ($domaine == 3) {return('Distribution/Consommation');}
	if ($domaine == 4) {return("Energie/Environnement");}
	if ($domaine == 5) {return('Industrie/Chimie');}
	if ($domaine == 6) {return('IT/Telecom/Multimedia');}
	if ($domaine == 7) {return('Pharmacie/Santé');}
	if ($domaine == 8) {return('Transport/Service');}	
}

function AssocierMois($mois)
{
	if ($mois == 1) {return('de janvier');}
	if ($mois == 2) {return('de février');}
	if ($mois == 3) {return('de mars');}
	if ($mois == 4) {return("d'avril");}
	if ($mois == 5) {return('de mai');}
	if ($mois == 6) {return('de juin');}
	if ($mois == 7) {return('de juillet');}
	if ($mois == 8) {return("d'août");}	
	if ($mois == 9) {return('de septembre');}
	if ($mois == 10) {return("d'octobre");}
	if ($mois == 11) {return('de novembre');}
	if ($mois == 12) {return('de décembre');}
}
...
if ((!empty($genre))&&(empty($ecole))){}
if (preg_match("#^[AEIOUY]#",$ecole)){$ecole = "l'".$ecole;}
