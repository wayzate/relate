...
<div id="menumessages">
		...
		<ul>
			<li><a class="actif" href="messages.php"> Messages reçus </a></li>
		...
		echo "<div id='messageouvert'>
				<li class='enteterecu'>
					...
					<div class='marge'>{$mess['date']}</div>
			  		{$mess['title']}
					<div class='marge'><a href='nouveau_message.php?to={$mess['fromEmail']}&sub={$mess['title']}' class='btn_repondre'>Répondre</a></div>
				</li>
				<li class='contenuouvert'>
			  		{$mess['content']}<br />
			  	</li>
				<li class='piedmessage'>
					<a href='?m={$mess['id']}' class='supprimer'>Supprimer</a>
					<a href='nouveau_message.php?to={$mess['fromEmail']}&sub={$mess['title']}' class='repondre'>Répondre</a>
			  	</li>
			  </div><br />"; 
	}
}
?>
<!-- <a href='?m={$mess['id']}'>Supprimer ?</a> !-->
