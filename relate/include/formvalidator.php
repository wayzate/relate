...
define("E_VAL_REQUIRED_VALUE","Veuillez renseigner le champ %s");
define("E_VAL_MAXLEN_EXCEEDED","Taille maximum dépassée : %s.");
define("E_VAL_MINLEN_CHECK_FAILED","La taille minimale est de %d pour %s");
define("E_VAL_ALNUM_CHECK_FAILED","Veuillez remplir une donnée alpha-numerique pour %s");
define("E_VAL_ALNUM_S_CHECK_FAILED","Veuillez remplir une donnée alpha-numerique pour %s");
define("E_VAL_NUM_CHECK_FAILED","Veuillez remplir une donnée numerique pour %s");
define("E_VAL_ALPHA_CHECK_FAILED","Veuillez remplir une donnée alphabétique pour %s");
define("E_VAL_ALPHA_S_CHECK_FAILED","Veuillez remplir une donnée alphabétique pour %s");

define("E_VAL_EMAIL_NOT_ESTP","L'adresse mail n'est pas autorisée");

define("E_VAL_EMAIL_CHECK_FAILED","Veuillez fournir une adresse email valide");
define("E_VAL_LESSTHAN_CHECK_FAILED","Entrez une valeur plus petite que %f pour %s");
define("E_VAL_GREATERTHAN_CHECK_FAILED","Entrez une valeur plus grande que %f pour %s");
define("E_VAL_REGEXP_CHECK_FAILED","Veuillez renseigner correctement le champ %s");
define("E_VAL_DONTSEL_CHECK_FAILED","Mauvaise option pour %s");
define("E_VAL_SELMIN_CHECK_FAILED","Veuillez choisir au moins %d options pour %s");
define("E_VAL_SELONE_CHECK_FAILED","Veuillez choisir une option pour %s");
define("E_VAL_EQELMNT_CHECK_FAILED","La valeur de %s devrait être la même que celle de %s");
define("E_VAL_NEELMNT_CHECK_FAILED","La valeur de %s devrait différente de celle de %s");
...
class FormValidator 
{
	...
	{
		$bforme = preg_match("/^[_\.0-9a-zA-Z-]+@([0-9a-zA-Z][0-9a-zA-Z-]+\.)+[a-zA-Z]{2,6}$/i", $email);
		return $bforme;
	}
	...
	function ValidateCommand($command,$command_value,$input_value,&$default_error_message,$variable_name,$formvariables)
	{
		...
		switch($command)
		{
			...
			case "email_estp" :
						{
							if(substr_compare($input_value,"@eleves.estp.fr",-15) != 0 && $_POST['type'] == "etudiant")
									{
										$default_error_message = E_VAL_EMAIL_NOT_ESTP;
										$bret = false;
									}
							break;
						}
