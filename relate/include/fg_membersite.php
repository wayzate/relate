...
class FGMembersite
{
   ...
   function FGMembersite()
    ...
    function InsertIntoDB(&$formvars)
    {
    	...
    	"' . $confirmcode . '",
    	"' . $this->SanitizeForSQL($formvars['mainSchool']) . '"
    	)';
    ...
    function ChangeProfileInDB($user_rec,$profile_vars)  //Attention. La fonction changeprofile doit être encadré par un BEGIN et un COMMIT/ROLLBACK
    {
...
/**/   								//var_dump($insertquery,$res);    							
    ...
    function CollectRegistrationSubmission(&$formvars)
    {
        ...
        var_dump($_POST['mainSchool']);
        $formvars['mainSchool'] = $this->Sanitize($_POST['mainSchool']);        //ajout
