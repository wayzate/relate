...
<div id="menumessages">
		...
		<ul>
			...
			<li><a class="actif" href="#"> Messages envoyés </a></li>
...
foreach($sentbox as $i => $mess) {		
	...
	$objet = ($mess['title'] == "" || !isset($mess['title']))?"- Aucun objet -":$mess['title'];
		echo "<div id='message'>
				<li class='enteteenvoyes'><a href='ouverture_message_envoye.php?m=$i'>
					<div class='expediteur'>À {$mess['toName']} {$mess['toSurname']}</div> 
